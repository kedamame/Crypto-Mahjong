...
const REGULAR_TILES: TileInfo[] = [
  ...
  { id: 'ATOM',   label: 'ATOM',   symbol: 'A', suit: 'l1',     matchGroup: 'ATOM',   suitColor: '#3558c8' },
  { id: 'NEAR',   label: 'NEAR',   symbol: 'N', suit: 'l1',     matchGroup: 'NEAR',   suitColor: '#3558c8' },
  { id: 'FTM',    label: 'FTM',    symbol: 'F', suit: 'l1',     matchGroup: 'FTM',    suitColor: '#3558c8' },
  ...
  { id: 'BASE',   label: 'BASE',   symbol: 'B', suit: 'l2',     matchGroup: 'BASE',   suitColor: '#7c3aed' },
  { id: 'ZK',     label: 'ZK',     symbol: 'Z', suit: 'l2',     matchGroup: 'ZK',     suitColor: '#7c3aed' },
  { id: 'IMX',    label: 'IMX',    symbol: 'I', suit: 'l2',     matchGroup: 'IMX',    suitColor: '#7c3aed' },
  { id: 'SCROLL', label: 'SCROLL', symbol: 'S', suit: 'l2',     matchGroup: 'SCROLL', suitColor: '#7c3aed' },
  { id: 'STRK',   label: 'STRK',   symbol: 'S', suit: 'l2',     matchGroup: 'STRK',   suitColor: '#7c3aed' },
  { id: 'BLAST',  label: 'BLAST',  symbol: 'B', suit: 'l2',     matchGroup: 'BLAST',  suitColor: '#7c3aed' },
  { id: 'MANTA',  label: 'MANTA',  symbol: 'M', suit: 'l2',     matchGroup: 'MANTA',  suitColor: '#7c3aed' },
  { id: 'DEGEN',  label: 'DEGEN',  symbol: 'D', suit: 'wind',   matchGroup: 'DEGEN',  suitColor: '#141410' },
  { id: 'HIGHER', label: 'HIGHER', symbol: 'H', suit: 'wind',   matchGroup: 'HIGHER', suitColor: '#141410' },
  { id: 'MATIC',  label: 'MATIC',  symbol: 'M', suit: 'wind',   matchGroup: 'MATIC',  suitColor: '#141410' },
...
export const LAYER_DX = 3;
export const LAYER_DY = 3;

export function tilePixelPos(tile: GameTile): { x: number; y: number; z: number } {
  return {
    x: tile.col * TILE_W + tile.layer * LAYER_DX,
    y: tile.row * TILE_H - tile.layer * LAYER_DY,
    z: tile.layer * 10 + (tile.col + tile.row * 0.1),
  };
}

// Accommodate widest layout (cols 0-11) and tallest stack (8 layers)
export const BOARD_W = 12 * TILE_W + 8 * LAYER_DX + TILE_W;
export const BOARD_H = 8 * TILE_H + 8 * LAYER_DY + TILE_H;
